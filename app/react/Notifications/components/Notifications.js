...
class Notifications extends _react.Component {
  render() {
    return /*#__PURE__*/(
      ...
      _react.default.createElement(_Notification.default, _extends({ key: notification.id }, notification)))));
