"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.default = _default;exports.validateDuplicatedLabel = validateDuplicatedLabel;exports.validateDuplicatedRelationship = validateDuplicatedRelationship;function validateName(templates, id) {
  return {
...
function _default(properties, commonProperties, templates, id) {
  const validator = {
    '': {},
