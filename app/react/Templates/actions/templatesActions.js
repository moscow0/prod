"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.checkTemplateCanBeDeleted = checkTemplateCanBeDeleted;exports.deleteTemplate = deleteTemplate;exports.setAsDefault = setAsDefault;var _TemplatesAPI = _interopRequireDefault(require("../TemplatesAPI"));
...
function deleteTemplate(template) {
  return (dispatch) =>
  _TemplatesAPI.default.delete(new _RequestParams.RequestParams({ _id: template._id })).then(() => {
...
function checkTemplateCanBeDeleted(template) {
  return () =>
  _DocumentsAPI.default.
  countByTemplate(new _RequestParams.RequestParams({ templateId: template._id })).
