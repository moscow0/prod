"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.default = exports.TimelineViewer = void 0;
...
const dateProperties = Object.keys(_timelineFixedData.renderableTemplates).reduce(
(memo, t) =>
...
class TimelineViewer extends _react.Component {
  ...
  assignTrackLabels(tracks, isMainMatter) {
    ...
    (template) => template._id === (!isMainMatter ? _timelineFixedData.caseTemplate : _timelineFixedData.matterTemplate));
    ...
    if (tracks.related) {
      ...
      (template) => template._id === _timelineFixedData.matterTemplate);
  ...
  getRelatedEntity(references, isCase) {
    ...
    (r) => r.entityData.template === (isCase ? _timelineFixedData.matterTemplate : _timelineFixedData.caseTemplate));

    if (relatedEntity) {
      fetchRelatedEntity = _EntitiesAPI.default.get(
      new _RequestParams.RequestParams({ sharedId: relatedEntity.entityData.sharedId })).
      then((results) =>
      _formater.default.prepareMetadata(results[0], this.props.templates, this.props.thesauris));
  ...
  getTimelineInfo(entity) {
    ...
    then((references) => {
      ...
      references,
      isCase ? _timelineFixedData.matterTemplate : _timelineFixedData.caseTemplate);
  ...
  filterUsefulReferences(entity, references, relatedReferences, isCase) {
    ...
    (t) => t._id === (isCase ? _timelineFixedData.matterTemplate : _timelineFixedData.caseTemplate)).
    name;
  ...
  render() {
      ...
      tracks.keys.forEach((trackName) => {
        ...
        tracks[trackName] = Object.keys(track.years).map((year) => {
          ...
          return /*#__PURE__*/(
            ...
            _jsx(_ShowIf.default, { if: year === track.active.start }, void 0, /*#__PURE__*/
            ...
            track.years[year].map((reference, index) => {
              if (reference.reference) {
                ...
                return /*#__PURE__*/(
                  ...
                  _jsx(_ShowIf.default, { if: reference.firstMilestone }, void 0, /*#__PURE__*/
                  ...
                  _jsx(_ShowIf.default, { if: reference.additionalData.type === 'judgement' }, void 0, /*#__PURE__*/
              ...
              if (!reference.reference) {
                return /*#__PURE__*/(
                  ...
                  _jsx("span", { className: "timeline-milestone " }, void 0, /*#__PURE__*/
                  _jsx("span", {}, void 0,
                  `${_moment.default.utc(reference.timestamp * 1000).format('MMM YYYY')}`)))));
    ...
    return /*#__PURE__*/(
      ...
      _jsx(_ShowIf.default, { if: Boolean(this.state && this.state.tracks && this.state.tracks.related) }, void 0, /*#__PURE__*/
