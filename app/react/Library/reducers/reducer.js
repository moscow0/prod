...
if (_utils.isClient) {
  ...
  _immutable.default.fromJS(window.__reduxData__.templates) :
  null;
}
...
defaultSearch.publishedStatus = { values: ['published', 'restricted'] };var _default =

(storeKey) =>
(0, _redux.combineReducers)({
  aggregations: (0, _Multireducer.multireducer)(_aggregationsReducer.default, storeKey),
  documents: (0, _Multireducer.multireducer)(_documentsReducer.documentsReducer, storeKey),
  ui: (0, _Multireducer.multireducer)(
  (0, _Attachments.manageAttachmentsReducer)(_uiReducer.default, {
    useDefaults: false,
  ...
  sidepanel: (0, _redux.combineReducers)({
    ...
    quickLabelState: (0, _BasicReducer.default)(`${storeKey}.sidepanel.quickLabelState`, {}),
    quickLabelMetadata: (0, _reactReduxForm.modelReducer)(`${storeKey}.sidepanel.quickLabelMetadata`, {}),
    quickLabelMetadataForm: (0, _reactReduxForm.formReducer)(`${storeKey}.sidepanel.quickLabelMetadata`, {}),
    references: (0, _BasicReducer.default)(`${storeKey}.sidepanel.references`, []),
    snippets: (0, _BasicReducer.default)(`${storeKey}.sidepanel.snippets`, {
      count: 0,
      metadata: [],
      fullText: [] }),
