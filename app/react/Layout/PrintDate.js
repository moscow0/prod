...
const PrintDate = ({ utc, toLocal }) => {
  let date;
  if (!toLocal) {
    date = _moment.default.utc(utc).format('ll');
  }

  if (toLocal) {
    date = (0, _moment.default)((0, _moment.default)(utc).toDate()).format('ll');
  }
  return /*#__PURE__*/_jsx("span", {}, void 0, date);
};var _default =
...
PrintDate;exports.default = _default;