"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;exports.mapStateToProps = mapStateToProps;var _reactRedux = require("react-redux");
...
function conformSearchQuery(types) {
  return _SearchAPI.default.search(new _RequestParams.RequestParams({ types, limit: 0 }));
}
...
function prepareData(countries, setA, setB) {
  ...
  const provisionalMeasureLabel = (0, _I18N.t)(
  provisionalMeasuresTemplate,
  ...
  return countries.map((_country) => {
    ...
    const provisionalMeasureResults = _parsingUtils.default.findBucketsByCountry(
    setB,
    countryKey,
    country.key);
