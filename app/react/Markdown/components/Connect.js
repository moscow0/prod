...
class Connect extends _react.Component {
  ...
  static renderChildren(children, props) {
    ...
    children.map((child, index) => /*#__PURE__*/_react.default.cloneElement(child, _objectSpread(_objectSpread({}, props), {}, { index }))) : /*#__PURE__*/
  ...
  render() {
    ...
    return /*#__PURE__*/(
      _jsx(_Context.default.Provider, { value: props }, void 0,
