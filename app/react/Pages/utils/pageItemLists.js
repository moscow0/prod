"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _risonNode = _interopRequireDefault(require("rison-node"));
...
const extractAdditionalOptions = (content, match) => {
  ...
  if (optionsMatch) {
    ...
    try {
      options = _risonNode.default.decode(`(${optionsMatch})`);
    } catch (err) {
      options = {};
    }
  }
