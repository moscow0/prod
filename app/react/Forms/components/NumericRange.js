...
class NumericRange extends _react.Component {
  ...
  render() {
    return /*#__PURE__*/(
      ...
      _jsx(_I18N.Translate, { translationKey: "Label date \"From\"" }, void 0, "From:"), /*#__PURE__*/
      _jsx(_Numeric.default, { value: this.state.from, onChange: (val) => this.onChange('from', val) })), /*#__PURE__*/

      _jsx("div", { className: "Numeric__To" }, void 0, /*#__PURE__*/
      _jsx(_I18N.Translate, { translationKey: "Label date \"to\"" }, void 0, "To:"), /*#__PURE__*/
