...

{
  ...
  save(requestParams) {
    return _api.default.post('documents', requestParams).then((response) => response.json);
  },

  delete(requestParams) {
    return _api.default.delete('documents', requestParams).then((response) => response.json);
