"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.default = exports.SearchResults = void 0;var _propTypes = _interopRequireDefault(require("prop-types"));
...
class SearchResults extends _react.Component {
  render() {
    ...
    _jsx(_Layout.Icon, { className: "item-icon item-icon-center", data: result.icon }),
    result.title)), /*#__PURE__*/


    _jsx("div", { className: "item-actions" }, void 0, /*#__PURE__*/
    _jsx(_Layout.TemplateLabel, { template: result.template }))));
  ...
  }}exports.SearchResults = SearchResults;var _default =
...
SearchResults;exports.default = _default;