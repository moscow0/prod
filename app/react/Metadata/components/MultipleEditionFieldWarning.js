"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.mapStateToProps = exports.default = exports.MultipleEditionFieldWarningBase = void 0;
...
class MultipleEditionFieldWarningBase extends _react.Component {
  render() {
  ...
  }}exports.MultipleEditionFieldWarningBase = MultipleEditionFieldWarningBase;
...
const mapStateToProps = (state, props) => {
  const fieldState = (0, _reactReduxForm.getField)(state, `${props.model}.${props.field}`) || { pristine: true };
...
(0, _reactRedux.connect)(mapStateToProps)(MultipleEditionFieldWarningBase);exports.default = _default;