...
class Feedback extends _react.Component {
  render() {
    const type = this.props.type || 'info';
    if (type === 'success') {
      return /*#__PURE__*/(
        _jsx("span", { className: "feedback feedback-success" }, void 0, /*#__PURE__*/
        _jsx(_UI.Icon, { icon: "check" }), " ", this.props.children));


    }
    if (type === 'error') {
      return /*#__PURE__*/(
        _jsx("span", { className: "feedback feedback-error" }, void 0, /*#__PURE__*/
        _jsx(_UI.Icon, { icon: "exclamation-triangle" }), " ", this.props.children));


    }
    if (type === 'info') {
      return /*#__PURE__*/(
        _jsx("span", { className: "feedback feedback-info" }, void 0, /*#__PURE__*/
        _jsx(_UI.Icon, { icon: "info-circle" }), " ", this.props.children));
...
Feedback;exports.default = _default;