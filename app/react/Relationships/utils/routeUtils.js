"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.emptyState = emptyState;exports.requestState = requestState;exports.setReduxState = setReduxState;
...
function requestState(requestParams, state) {
  return _referencesAPI.default.getGroupedByConnection(requestParams).then((connectionsGroups) => {
    ...
    return Promise.all([
    connectionsGroups,
    _ConnectionsList.actions.search(newParams),
    params.sort,
    params.filters]);
...
function setReduxState(state) {
  return (dispatch) => {
    ...
    dispatch(
    _BasicReducer.actions.set('relationships/list/searchResults', state.relationships.list.searchResults));
