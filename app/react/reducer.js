...
var _reducer3 = _interopRequireDefault(require("./Thesauri/reducers/reducer"));
...
var _reducer16 = _interopRequireDefault(require("./Review/reducers/reducer"));
var _exportReducer = _interopRequireDefault(require("./Library/reducers/exportReducer"));

var _reactReduxForm = require("react-redux-form");function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} /** @format */var _default =
...
(0, _redux.combineReducers)({
  ...
  entityThesauris: (0, _BasicReducer.default)('entityThesauris', {}),
  ...
  metadata: _reducer14.default,
  oneUpReview: _reducer16.default,
  exportSearchResults: _exportReducer.default,
  userGroups: (0, _BasicReducer.default)('userGroups', []) });exports.default = _default;