"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.checkRelationTypeCanBeDeleted = checkRelationTypeCanBeDeleted;exports.deleteRelationType = deleteRelationType;exports.editRelationType = editRelationType;var _RelationTypesAPI = _interopRequireDefault(require("../RelationTypesAPI"));
...
function checkRelationTypeCanBeDeleted(relationType) {
  return function () {
    ...
    countByRelationType(new _RequestParams.RequestParams({ relationtypeId: relationType._id })).
    then((count) => {
      if (count) {
