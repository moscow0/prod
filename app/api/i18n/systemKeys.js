...
{ key: 'Add template', label: 'Add template' },
...
{
  key: 'Apply properties to documents/entities',
  label: 'Apply properties to documents/entities' },
...
{
  key: 'Confirm delete document type message',
  label: 'Are you sure you want to delete this document type?' },
...
{ key: 'Confirm delete document type title', label: 'Connection type' },
{
  ...
  label: 'Are you sure you want to delete all the selected items?' },
...
{
  key: 'Invalid form',
  label: 'An entry is required or has an invalid value. Please correct and try again.' },
...
{
  key: 'No Connections description',
  label:
  'Connections are the direct relationships between this document and other documents and entities.' },

{ key: 'No Label', label: 'No Label' },
{ key: 'No References', label: 'No References' },
{
  key: 'No References description',
  label:
  'References are pieces of text from this document related to other documents or entities.' },
...
{
  key: 'No text match description',
  label: 'You can type something different in the search box to get some results.' },
...
{ key: 'Password Error', label: 'Password Error!  Both fields are required and should match' },
...
{
  key: 'Search text description',
  label: 'Type something in the search box to get some results.' },
...
{
  key: 'This action will unselect all the entities.',
  label: 'This action will unselect all the entities.' },
...
{
  key: 'check as private instance',
  label: 'Check to make this instance private (only logged users access the data)' },
...

{
  ...
  'containing both the words status and women, and necessarily not containing the word Nicaragua.' }];exports.default = _default;