"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.checkIfReindex = checkIfReindex;var _lodash = _interopRequireDefault(require("lodash"));

var _templates = _interopRequireDefault(require("./templates"));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
function compareTemplateProperties(updatedProperties, originalProperties) {
  ...
  originalProperties.forEach((originalProperty) => {
    ...
    Object.keys(updatedProperty).forEach((originalKey) => {
      if (
      originalKey !== '_id' &&
      !_lodash.default.isEqual(updatedProperty[originalKey], originalProperty[originalKey]))
      {
...
async function checkIfReindex(updatedTemplate) {
  if (updatedTemplate._id) {
    let changedProperties = [];
    const [originalTemplate] = await _templates.default.get({ _id: updatedTemplate._id });
