...
var _ = require("./"); /* eslint-disable max-statements */
...
(route, io) => {
  ...
  const originalValidateRequest = _.validation.validateRequest;
  spyOn(_.validation, 'validateRequest').and.callFake((schema) => schema);
  route(app, io);
  _.validation.validateRequest = originalValidateRequest;
