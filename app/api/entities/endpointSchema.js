"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.saveSchema = exports.metadataSchema = exports.iconSchema = void 0;

var _joi = _interopRequireDefault(require("joi"));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} /** @format */
...
// Must match entitiesModel.js interfaces!
const metadataSchema = _joi.default.object().
keys().
pattern(
_joi.default.string(),
_joi.default.array().items(
_joi.default.object().keys({
  value: _joi.default.alternatives().try(
  _joi.default.number(),
  _joi.default.string(),
  dateRangeSchema,
  _joi.default.object().keys({
  ...
  label: _joi.default.string().allow(null).allow('') })));exports.metadataSchema = metadataSchema;
...
const saveSchema = _joi.default.object().
keys({
