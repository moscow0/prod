...
var _PdfCharacterCountToAbsolute = require("../../pdf_character_count_to_absolute/PdfCharacterCountToAbsolute");
var _path = _interopRequireDefault(require("path"));
var _config = require("../../../config");function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} /* eslint-disable no-await-in-loop */

async function getCharacterCountToAbsolutePositionConvertor(file) {
  const filename = _path.default.join(_config.config.defaultTenant.uploadedDocuments, file.filename);
  const pageEndingCharacterCount = Object.values(file.pdfInfo).map((x) => x.chars);

  const characterCountToAbsoluteConversion = new _PdfCharacterCountToAbsolute.PdfCharacterCountToAbsolute();
