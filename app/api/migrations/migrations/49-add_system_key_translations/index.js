...
var _csv = _interopRequireDefault(require("../../../csv/csv"));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} //eslint-disable-next-line node/no-restricted-import
...
async function readCsvToSystemKeys(db, filename) {
  const fstream = _fs.default.createReadStream(filename);
...

{
  ...
  async up(db) {
    ...
    db,
    'app/api/migrations/migrations/49-add_system_key_translations/system_keys.csv');
