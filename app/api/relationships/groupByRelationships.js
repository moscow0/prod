"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.groupRelationships = exports.filterRelevantRelationships = void 0;function getGroupData(reference, groupedReferences, _templates, relationTypes) {
...
Boolean(ref.entity !== id && (ref.entityData && ref.entityData.published || user)));exports.filterRelevantRelationships = filterRelevantRelationships;
...
};exports.groupRelationships = groupRelationships;