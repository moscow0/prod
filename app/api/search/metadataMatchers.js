"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.textFilter = exports.strictNestedFilter = exports.relationshipfilter = exports.rangeFilter = exports.nestedFilter = exports.multiselectFilter = exports.default = exports.daterange = void 0;const textFilter = (filter, path = 'metadata') => ({
  term: { [`${path}.${filter.name}`]: filter.value } });exports.textFilter = textFilter;
...
const strictNestedFilter = (filter) => {
  ...
  return match;
};exports.strictNestedFilter = strictNestedFilter;
...
filterToMatch;exports.default = _default;