"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.searchParamsSchema = exports.emitSchemaTypes = void 0;const emitSchemaTypes = true;exports.emitSchemaTypes = emitSchemaTypes;
  ...
  properties: {
    query: {
      ...
      properties: {
        ...
        includeReviewAggregations: { type: 'boolean' } } } } };exports.searchParamsSchema = searchParamsSchema;